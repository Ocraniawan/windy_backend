...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 23, 2020 at 09:36 AM
...
INSERT INTO `hotel` (`id`, `name`, `location_id`, `longitude`, `latitude`, `description`, `image`, `created_on`, `updated_on`) VALUES
(1, 'Airy Baranangsiang Riau 39 Bogor', 1, '-6.6084566', '106.8066823', 'Pihak hotel mungkin akan meminta deposit untuk menutupi pembayaran tak terduga.', 'airy-baranangsiang.jpeg', '2020-01-22 09:07:43', '2020-01-22 09:07:43'),
(3, 'Airy Syariah Pakuan Ciheuleut 12 Bogor', 1, '-6.6068945', '106.8086576', 'AIRY SYARIAH adalah pilihan alternatif yang memadukan konsep perhotelan dengan kaidah syariah. Bagi tamu berlawanan jenis, akan diminta untuk menunjukkan dokumen Akta Nikah (bagi pasangan) atau Kartu Keluarga (bagi anggota keluarga yang berbeda jenis kelamin).', 'Airy Syariah Pakuan Ciheuleut 12 Bogor.jpeg', '2020-01-22 10:29:17', '2020-01-22 10:29:17');
...
INSERT INTO `user` (`id`, `title_id`, `username`, `first_name`, `last_name`, `phone_number`, `email`, `password`, `image`, `created_on`, `updated_on`) VALUES
(1, 1, 'ocraniawan', 'Ocraniawan', 'Patattan', 2147483647, 'ocraniawan@user.com', '$2a$10$dY0bOkkslbv9RaawFqRApO9QpLLVXxL/LhhqfTkduKW3vPW/Nsdl2', 'coffe.jpg', '2020-01-22 05:03:02', '2020-01-22 05:03:02');
